...
parser.add_argument('--config',default='models/siamrpn_alex_dwxcorr/config.yaml',type=str,help='config file')
parser.add_argument('--snapshot', default='models/siamrpn_alex_dwxcorr/model.pth',type=str, help='model name')
parser.add_argument('--video_name', default='videos/bag.avi', type=str,help='videos or image files')
